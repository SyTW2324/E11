...
afterAll(() => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, supertest_1.default)(server_1.app).get("/user/test").then((res) => {
        return (0, supertest_1.default)(server_1.app).delete("/user/" + res.body._id);
    });
    yield (0, supertest_1.default)(server_1.app).get("/user/test2").then((res) => {
        return (0, supertest_1.default)(server_1.app).delete("/user/" + res.body._id);
    });
...
describe("user routes", () => {
    ...
    it("should delete a user", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(server_1.app).get("/user/test").then((res) => {
            return (0, supertest_1.default)(server_1.app).delete("/user/" + res.body._id);
        });
    }));
});
